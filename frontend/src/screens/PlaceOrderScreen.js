...
export default function PlaceOrderScreen(props) {
    ...
    cart.shippingPrice = cart.itemsPrice > 3000? toPrice(0): toPrice(200)
    ...
    return (
        <div>
            ...
            <div className="row top">
                    ...
                    {cart.cartItems.map((item) => (
                            <li key={item.product}>
                                <div className="row">
                                    ...
                                    <div>{item.qty} x R{item.price} = R{item.qty * item.price}</div>
                ...
                <div className="col-1"><div className="card card-body">
                    <ul>
                        <li>
                            <h2>Order Summary</h2>
                        </li>
